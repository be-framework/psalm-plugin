...
use Be\PsalmPlugin\Internal\AttributeNodeUtil;
use Be\PsalmPlugin\Issue\ConflictingBeingParameterAttribute;
use Be\PsalmPlugin\Issue\MissingBeingParameterAttribute;
use Override;
use PhpParser\Node;
use Psalm\Aliases;
...
final class BeingParameterAttributeHandler implements AfterClassLikeVisitInterface
{
    ...
    public static function afterClassLikeVisit(AfterClassLikeVisitEvent $event): void
    {
        ...
        $className = $event->getStorage()->name;
